...
const ExperienceCard = ({ id, lang, experience }: ExperiencieCardProps) => {
  ...
  return (
    <div className="w-full min-h-[550px] lg:min-h-[400px] flex flex-row transition-all ease-in-out duration-100">
      {/** Number */}
      <div className="hidden flex-1 lg:flex items-start pt-8">

  ...
  return (
    ...
    >
      <div className='flex flex-col'>
        <h2 className="text-4xl uppercase lg:text-6xl font-poppinsExtraBold font-bold text-blue-600 dark:text-dark-primary-perzonalized lg:mb-2">
          {dictionaryData.title['title-first-part'][lang]}
        </h2>
        <h2 className="text-4xl uppercase lg:text-6xl font-poppinsExtraBold font-bold text-gray-600 dark:text-dark-secondary-perzonalized mb-4 lg:mb-20">

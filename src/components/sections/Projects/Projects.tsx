...
const Projects = ({ lang }: ProjectsProps) => {
  ...
  return (
    <div className="transition-transform justify-center duration-1000 ease-[cubic-bezier(0.17, 0.55, 0.55, 1)] delay-500 text-gray-800 w-full max-w-7xl min-h-[500px] lg:min-h-[600px] h-auto flex flex-col items-center justify-start  gap-6 px-4 lg:px-0 pt-20">
      <div className="relative flex flex-col items-center justify-center">
        <h2 className={`text-lg  lg:text-xl font-bold text-gray-600 dark:text-yellow-500 w-fit`}> 
          {dictionaryData.title[lang]}
        </h2>
        <h2 className="mt-1 text-3xl font-semibold text-blue-600 dark:text-white">
